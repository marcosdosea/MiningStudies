...
public class ClassStudy implements Study {
	...
	public static void main(String[] args) {
		new RepoDriller().start(new ClassStudy());
	}
	...
	private void mineWebApplications() {
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Web/openmrs-core"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Web/class-openmrs-core-metrics.csv")).mine();
...
//				.through(Commits.onlyInHead()).withThreads(5)
//				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Web/class-JDeSurvey-metrics.csv")).mine();
//
//		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Web/web-budget"))
//				.through(Commits.onlyInHead()).withThreads(5)
//				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Web/class-web-budget-metrics.csv")).mine();
	}
	...
	private void mineEclipseApplications() {
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Eclipse/Activiti-Designer"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Eclipse/class-Activiti-Designer-metrics.csv"))
				.mine();

		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Eclipse/angularjs-eclipse"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Eclipse/class-angularjs-eclipse-metrics.csv"))
				.mine();
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Eclipse/droolsjbpm-tools"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Eclipse/class-droolsjbpm-tools-metrics.csv"))
				.mine();

		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Eclipse/sonarlint-eclipse"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new MethodVisitorMetric(), new CSVFile("D:/Projetos/_Eclipse/class-sonarlint-eclipse-metrics.csv"))
				.mine();
	}
	...
	private void mineAndroidApplications() {
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/bitcoin-wallet"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Android/bitcoin-wallet-metrics.csv")).mine();

		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/ExoPlayer"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Android/ExoPlayer-metrics.csv")).mine();

		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/Talon-for-Twitter"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Android/Talon-for-Twitter-metrics.csv"))
				.mine();

		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/sms-backup-plus"))
				.through(Commits.onlyInHead()).withThreads(5)
				.process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Android/sms-backup-plus-metrics.csv")).mine();

		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/k-9")).through(Commits.onlyInHead())
				.withThreads(5).process(new ClassVisitorMetric(), new CSVFile("D:/Projetos/_Android/k-9-metrics.csv"))
				.mine();
	}
	...
	private void mineVersions() {
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/k-9")).through(Commits.list(k9Android))
			.withThreads(5)
			.process(new ClassVisitorMetric(filterAndroidDesignRoles), new CSVFile("D:/Projetos/_Android/versions-class-k-9-metrics.csv")).mine();
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Eclipse/droolsjbpm-tools"))
			...
			.process(new ClassVisitorMetric(filterEclipseDesignRoles), new CSVFile("D:/Projetos/_Eclipse/versions-class-droolsjbpm-tools-metrics.csv"))
			.mine();
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Web/openmrs-core"))
			...
			.process(new ClassVisitorMetric(filterWebDesignRoles), new CSVFile("D:/Projetos/_Web/versions-class-openmrs-core-metrics.csv"))
			.mine(); 
	}
