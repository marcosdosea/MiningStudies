...
public class DWSurveyStudy {

	static Logger logger = LoggerFactory.getLogger(DWSurveyStudy.class);

	public static void main(String[] args) {

		String localFolder = "D:\\Projetos\\_Web\\DWSurvey";
		...
		listThresholdsTechiniques.addAll(
				CarregaSalvaArquivo.carregarLimiares(System.getProperty("user.dir") + "\\thresholds\\web2020\\DWSurvey"));
