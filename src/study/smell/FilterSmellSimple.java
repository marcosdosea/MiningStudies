...
public class FilterSmellSimple {
	...
	public static void main(String[] args) {
		...
		MetricReport metricasProjetosAnalisar = executor.getMetricsFromProjects(projetosAnalisar, PASTA_RESULTADO,
				"efdc59004cd254692aa749fab3b1c35aa6680a9d");
		...
		FilterSmellResult result = FilterSmells.filtrar((MetricReport) metricasProjetosAnalisar.all(), listaTecnicas,
				"HEAD");
		FilterSmells.gravarMetodosSmellProgramador(result.getMetodosSmell(),
				System.getProperty("user.dir") + "\\results\\SMELLS.csv");
		FilterSmells.gravarClassesSmellProgramador(result.getClassesSmell(),
				System.getProperty("user.dir") + "\\results\\SMELLS-classes.csv");
	}
}
